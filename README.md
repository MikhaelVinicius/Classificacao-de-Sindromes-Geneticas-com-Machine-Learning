...
This project was developed as part of the practical assessment for the Machine Learning Developer position at Apollo Solutions. The main objective is to analyze image embeddings (320-dimensional feature vectors) to classify genetic syndromes.
